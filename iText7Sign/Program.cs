    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (MemoryStream os = new MemoryStream())
            {
                ...
                //PdfSignature signature = stamper.GetSignatureDictionary();
                //var byteRange = signature.GetByteRange();
                //var docDigest = DigestAlgorithms.Digest(byteRange, DigestAlgorithms.GetMessageDigest("SHA-256"));
